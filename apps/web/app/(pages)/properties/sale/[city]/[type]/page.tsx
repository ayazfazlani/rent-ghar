...
export async function generateMetadata(
  ...
  if (!cityData) {
    return { title: `Properties for Sale in ${citySlug} | Property Dealer` };
  }
  ...
  if (isPropertyType && propertyType) {
    ...
    return {
      title: cityData.metaTitle
        ...
        : `${typeCapitalized} for Sale in ${cityData.name} | Property Dealer`,
      description: cityData.metaDescription || `Find the best ${propertyType} for sale in ${cityData.name}. Browse latest listings on Property Dealer.`,
      alternates: {
  ...
  if (areaData) {
    return {
      title: areaData.metaTitle || `Properties for Sale in ${areaData.name}, ${cityData.name} | Property Dealer`,
