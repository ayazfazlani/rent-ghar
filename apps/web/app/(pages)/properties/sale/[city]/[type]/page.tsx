...
export async function generateMetadata(
  ...
  if (!cityData) {
    return { title: `Properties for Sale in ${citySlug} | RENT-GHAR` };
  }
  ...
  if (isPropertyType && propertyType) {
    ...
    return {
      title: cityData.metaTitle
        ...
        : `${typeCapitalized} for Sale in ${cityData.name} | RENT-GHAR`,
      description: cityData.metaDescription || `Find the best ${propertyType} for sale in ${cityData.name}. Browse latest listings.`,
      alternates: {
  ...
  if (areaData) {
    return {
      title: areaData.metaTitle || `Properties for Sale in ${areaData.name}, ${cityData.name} | RENT-GHAR`,
      description: areaData.metaDescription || `Find properties for sale in ${areaData.name}, ${cityData.name}. Browse latest listings.`,
      alternates: {
