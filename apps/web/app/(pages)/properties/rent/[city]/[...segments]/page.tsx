...
export async function generateMetadata(
  ...
  // Find typeContent matching this type for rent (accepts 'rent' or 'all' purpose)
...
export default async function RentCitySegmentsPage(props: PageProps) {
  ...
  // Find typeContent: rent page matches 'rent' or 'all' purpose
  ...
  // - area+type → nothing
  // - area-only → areaData.rentContent (rent-specific) or areaData.description
